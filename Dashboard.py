...
app.layout = html.Div(children=[
    ...
    dcc.Dropdown(
        ...
        value='Yearly Statistics',  # Default
        placeholder='Select Statistics',
        style={'width': '80%', 'padding': '3px',
               'fontSize': 20, 'text-align-last': 'center'}
    ),
...
def update_output_container(selected_statistics, input_year):
    if selected_statistics == 'Recession Period Statistics':
        ...
        # Plot 4 Bar chart for unemployment effect
    ...
    # TASK 2.6: Yearly Statistics
        ...
        # Plot 4 Total Advertisement Expenditure by type
